...
export const GAUNTLET_STATE_ACCOUNT = 'nvK4PqFmyPZftqUUwz8WNaBUAuZeqxnTRpZGprHtzdp'
export const GAUNTLET_USDC_TOKEN_ACCOUNT = 'jhdvoJ2bF3FYfLbshsJVpjwX95L3o5kgPkTXvmvNZf2'
